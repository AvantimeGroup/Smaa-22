...
function smaa_acf_init() {
	...
	if( function_exists('acf_register_block') ) {
		...
		acf_register_block(array(
			'name'				=> 'hero-split',
			'title'				=> __('Hero Split'),
			'description'		=> __('Hero split, 50/50 bild text. Design 2022'),
			'render_callback'	=> 'smaa_acf_block_render_callback',
			'category'			=> 'smaa-2021',
			'icon'				=> array('foreground' => '#f18e00', 'size' => '36', 'src' =>'align-right'),
			'keywords'			=> array( 'image + text ', 'Design 2021' ),
			'enqueue_assets' 	=> function(){
				wp_enqueue_style( 'block-hero-split', get_template_directory_uri() . '/template-parts/block/assets/css/hero-split.css', array(), '1.0.0' );
			  }, 
		));
		acf_register_block(array(
		...
		acf_register_block(array(
			'name'				=> 'range-slider',
			'title'				=> __('Compensation Range'),
			'description'		=> __('Compensation range slider calculator. Design 2022'),
			'render_callback'	=> 'smaa_acf_block_render_callback',
			'category'			=> 'smaa-2021',
			'icon'				=> array('foreground' => '#f18e00', 'size' => '36', 'src' =>'align-right'),
			'keywords'			=> array( 'Compensation', 'Design 2021' ),
			'mode'				=> 'edit',
			'enqueue_assets' 	=> function(){
				wp_enqueue_style( 'range-slider-block', get_template_directory_uri() . '/template-parts/block/assets/range1/dist/rsc.css', array(), '1.0.0' );
				wp_enqueue_style( 'range-slider', get_template_directory_uri() . '/template-parts/block/assets/range1/dist/rangeslider.css', array(), '1.0.0' );
			//	wp_enqueue_style( 'block-table-comp', get_template_directory_uri() . '/template-parts/block/assets/css/comp-table.css', array(), '1.0.0' );
				// wp_enqueue_style( 'tool-tip', get_template_directory_uri() . '/template-parts/block/assets/css/dagraknare-tooltip.css', array(), '1.0.0' );
				 wp_enqueue_script( 'range-slider-js', get_template_directory_uri() . '/template-parts/block/assets/range1/dist/rangeslider.js', array(), '1.0.0', true );
			  },  
		));
		acf_register_block(array(
			'name'				=> 'comp-table',
			'title'				=> __('Ersättnings Tabel'),
			'description'		=> __('Ersättnings Tabel. Design 2021'),
			'render_callback'	=> 'smaa_acf_block_render_callback',
			'category'			=> 'smaa-2021',
			'icon'				=> array('foreground' => '#f18e00', 'size' => '36', 'src' => 'editor-table'),
			'keywords'			=> array( 'Tab', 'Design 2021' ),
		...
		acf_register_block(array(
			'name'				=> 'combi-akassa-days',
			'title'				=> __('Ersättningsdagar: räkna och tabell'),
			'description'		=> __('Compensation days range slider calculator and table. Design 2022'),
			'render_callback'	=> 'smaa_acf_block_render_callback',
			'category'			=> 'smaa-2021',
			'icon'				=> array('foreground' => '#f18e00', 'size' => '36', 'src' =>'align-right'),
			'keywords'			=> array( 'Ersättnings dagar', 'Design 2021' ),
			'mode'				=> 'edit',
			'enqueue_assets' 	=> function(){
				wp_enqueue_style( 'range-slider-block', get_template_directory_uri() . '/template-parts/block/assets/range1/dist/rsc.css', array(), '1.0.0' );
				wp_enqueue_style( 'range-slider', get_template_directory_uri() . '/template-parts/block/assets/range1/dist/rangeslider.css', array(), '1.0.0' );
