                        ...
                        <div class="block-image-text-33-66">
                            ...
                            <?php # the_field('panel_1_img_pos'); ?>
                                <div class="column-33">          
                                    ...
                                    <?php $panel1_bild = get_field('panel_1_img');
                                      if( !empty( $panel1_bild ) ): ?>
                                        <img src="<?php echo esc_url($panel1_bild['url']); ?>" alt="<?php echo esc_attr($panel1_bild['alt']); ?>" />
                                    <?php endif; ?>
                                    </div>  
                                </div>
                    ...
                    <?php if( get_field('hidden_tab_and_panel_2') == 'yes' ): ?>
                        ...
                        <div class="block-image-text-33-66">
                            ...
                            <?php # the_field('panel_1_img_pos'); ?>
                                <div class="column-33">          
                                    <div class="left-image">
                                    <?php $panel2_bild = get_field('panel_2_img');
                                      if( !empty( $panel2_bild ) ): ?>
                                        <img src="<?php echo esc_url($panel2_bild['url']); ?>" alt="<?php echo esc_attr($panel2_bild['alt']); ?>" />
                                    <?php endif; ?>
                                    </div>  
                                </div>
                                <div class="column-66 <?php echo $class_text; ?>">
                    ...
                    <div id="tab-three-panel" class="panel">
                        ...
                        <div class="block-image-text-33-66">
                            ...
                            <?php # the_field('panel_1_img_pos'); ?>
                                <div class="column-33">          
                                    <div class="left-image">
                                    <?php $panel3_bild = get_field('panel_3_img');
                                      if( !empty( $panel3_bild ) ): ?>
                                        <img src="<?php echo esc_url($panel3_bild['url']); ?>" alt="<?php echo esc_attr($panel3_bild['alt']); ?>" />
                                    <?php endif; ?>
                                    </div>  
                                </div>
                                <div class="column-66 <?php echo $class_text; ?>">
                        ...
                        ?>
                            <div class="block-image-text-33-66">
                                ...
                                <?php # the_field('panel_1_img_pos'); ?>
                                    <div class="column-33">          
                                        <div class="left-image">
                                        <?php $panel4_bild = get_field('panel_4_img');
                                      if( !empty( $panel4_bild ) ): ?>
                                        <img src="<?php echo esc_url($panel4_bild['url']); ?>" alt="<?php echo esc_attr($panel4_bild['alt']); ?>" />
                                    <?php endif; ?>
                                        </div>  
                                    </div>
                                    <div class="column-66 <?php echo $class_text; ?>">
                        ...
                        <div id="tab-five-panel" class="panel">
                            ...
                            <div class="block-image-text-33-66">
                                ...
                                <?php # the_field('panel_1_img_pos'); ?>
                                    <div class="column-33">          
                                        <div class="left-image">
                                        <?php $panel5_bild = get_field('panel_5_img');
                                      if( !empty( $panel5_bild ) ): ?>
                                        <img src="<?php echo esc_url($panel5_bild['url']); ?>" alt="<?php echo esc_attr($panel5_bild['alt']); ?>" />
                                    <?php endif; ?>
                                        </div>  
                                    </div>
                                    <div class="column-66 <?php echo $class_text; ?>">
